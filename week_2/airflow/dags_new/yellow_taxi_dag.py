...
URL_TEMPLATE = URL_PREFIX + '/yellow_tripdata_'+str('{{ execution_date.strftime(\'%Y-%m\') }}')+'.parquet'
OUTPUT_FILE = 'yellow_tripdata_'+str('{{ execution_date.strftime(\'%Y-%m\') }}')+'.parquet'
OUTPUT_FILE_TEMPLATE_FP = 'yellow_tripdata_'+str('{{ execution_date.strftime(\'%Y-%m\') }}')+'.parquet'
